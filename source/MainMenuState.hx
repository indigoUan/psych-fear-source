...
{
	public static var fromTitle:Bool;
	...
	var optionShit:Array<String> = ['story_mode', 'freeplay', #if ACHIEVEMENTS_ALLOWED 'awards', #end 'credits'/*, #if !switch 'donate'*/, 'options'];
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			if (fromTitle == true) {
				FlxTween.tween(menuItem, {alpha: 1}, 8);
			}
		}
		...
		if (fromTitle == true) {
			FlxTween.tween(bg, {alpha: 1}, 18);
		}

		fromTitle = false;

		var versionShit2:FlxText = new FlxText(12, FlxG.height - 64, 0, "By the Untitled Funkers team (DEMO preview)", 12);
