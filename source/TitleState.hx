...
{
	public var letsFlash:Bool = true;
	...
	{
		var canLightOff:Bool = true;
		var randomLight:Int = (FlxG.random.int(1, 40));
		if (randomLight == 1 && canLightOff && letsFlash)
		{
			logoBl.color = FlxColor.fromRGB(80, 80, 80);
			canLightOff = false;
		...
		if (!transitioning && skippedIntro)
		{
			if(pressedEnter)
			{
				...
				letsFlash = false;
				FlxTween.tween(logoBl, {alpha: 0}, 0.5);
