...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Untitled Funkers'],
		['SmokeCannon',			'smoke',			'Musician and Director',							'https://youtu.be/dQw4w9WgXcQ',			0xFF0000FF],
		['Meshy',				'meshy', 			'Musician',											'https://youtu.be/dQw4w9WgXcQ', 		0xFFFFFFFF],
		['indigo',				'uan',				'Programmer',										'https://twitter.com/indigoUan',        0xFF4B0082],
		["MrFlamin'",			'flamin',			'Logo artist',				'https://www.youtube.com/channel/UC5z6qGZzkifFXFoA8Gqq1wA', 	0xFFF21811],
		['Ezekiel',				'eze',				'Artist',											'https://youtu.be/dQw4w9WgXcQ',			0xFFFFFFFF],
		['AbdulDraws',			'blank',			'Artist',											'https://youtu.be/dQw4w9WgXcQ',			0xFFFFFFFF],
		['Select',				'select',			'Artist',											'https://twitter.com/Select3222',		0xFFFF0094],
		['OJogador Animador',	'blank',			'Animator',											'https://youtu.be/dQw4w9WgXcQ',			0xFFFFFFFF],
